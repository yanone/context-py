...
def promote_intermediate_layers(font: Font, _args: dict):
    ...
    for loc_tuple, layers in additional_masters.items():
        ...
        for layer in layers:
            ...
            del layer.format_specific["com.glyphsapp"]["attr"]["coordinates"]
...
def intermediate_location(l: Layer, f: Font) -> Optional[Dict[str, float]]:
    if not l.format_specific or not l.format_specific["com.glyphsapp"]:
        return
    attr = l.format_specific["com.glyphsapp"].get("attr")
